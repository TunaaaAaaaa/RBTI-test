  ...
  return (
    <main className="min-h-screen relative flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-lg mx-auto">
        ...
        <p className="text-lg md:text-xl text-white/90 mb-3 font-bold drop-shadow leading-relaxed">研究员行为类型测试</p>
        <p className="text-sm text-blue-200/60 mb-12 drop-shadow leading-relaxed">
          你是 SCHOLAR 还是 SLOTH？是 EXPERIMENT 还是 THEORY？<br />30 道题，测出你的科研人格
        </p>
        <Link href="/rbti-test"
          className="inline-flex items-center gap-2 bg-white text-blue-600 px-10 py-4 rounded-full text-lg font-black hover:bg-blue-50 transition-all shadow-xl hover:shadow-2xl hover:scale-105 active:scale-95 pulse-glow">
          <span>开始测试</span>
